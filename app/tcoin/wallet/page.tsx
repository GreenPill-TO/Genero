    ...
    <>
      ...
      <main className="flex-grow">
        ...
        <section id="future" className="px-6 max-w-screen-xl mx-auto lg:w-1/2 lg:mx-[25%]">
          <h2 className="font-bold text-center mt-2 mb-4">The future of money is local</h2>
          <p className="mb-2">
        ...
        <section id="why" className="px-6 max-w-screen-xl mx-auto lg:w-1/2 lg:mx-[25%]">
          <h2 className="font-bold text-center mt-2 mb-4">Why TCOIN?</h2>
        ...
        <section id="how" className="px-6 max-w-screen-xl mx-auto lg:w-1/2 lg:mx-[25%]">
          <h2 className="font-bold text-center mt-2 mb-4">How It Works</h2>
          <p className="mb-2">
        ...
        <section id="real-life" className="px-6 max-w-screen-xl mx-auto lg:w-1/2 lg:mx-[25%]">
          <h2 className="font-bold text-center mt-2 mb-4">A Currency Designed for Real Life</h2>
          <p className="mb-2">
        ...
        >
          <h2 className="font-bold text-center mt-2 mb-4">Not Just Money - Infrastructure</h2>
          <p className="mb-2">
        ...
        <section id="who" className="px-6 max-w-screen-xl mx-auto lg:w-1/2 lg:mx-[25%]">
          <h2 className="font-bold text-center mt-2 mb-4">Who’s Behind This?</h2>
          <p className="mb-2">
        ...
        <section id="involved" className="px-6 max-w-screen-xl mx-auto lg:w-1/2 lg:mx-[25%]">
          <h2 className="font-bold text-center mt-2 mb-4">How to Get Involved</h2>
          <div className="space-y-4">
            <p>
        ...
        <section className="px-6 max-w-screen-xl mx-auto lg:w-1/2 lg:mx-[25%]">
          <h2 className="font-bold text-center mt-2 mb-4">What Are You Waiting For?</h2>
          <p className="mb-2">
            <span className="bg-gray-200 px-1">
