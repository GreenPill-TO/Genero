    ...
    <footer className={cn("py-6 w-full", "bg-background", "text-foreground")}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center [@media(max-width:767px)_and_(orientation:portrait)]:flex-col-reverse [@media(max-width:767px)_and_(orientation:portrait)]:items-stretch [@media(max-width:767px)_and_(orientation:portrait)]:gap-3">
          ...
          <div className="space-x-4 text-sm [@media(max-width:767px)_and_(orientation:portrait)]:flex [@media(max-width:767px)_and_(orientation:portrait)]:flex-col [@media(max-width:767px)_and_(orientation:portrait)]:space-x-0 [@media(max-width:767px)_and_(orientation:portrait)]:space-y-1 [@media(max-width:767px)_and_(orientation:portrait)]:text-right">
