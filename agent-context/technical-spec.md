...
- Homepage sets body font to the Special Elite typewriter font with Courier fallbacks via next/font; headings are bold, centred, and the same size as body text.
