...
- Wallet landing header now uses an absolute full-width gradient overlay anchored at `top-full` beneath the fixed bar (`h-16`, opaque-to-transparent), ensuring a visible fade-out as body content scrolls underneath.
