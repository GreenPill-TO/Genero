...
- Layout uses the Special Elite typewriter font via next/font with uniform text size; headings are bold and centred.
- Banner is limited to content width and navbar shows "/open your wallet/" linked to the dashboard.
