...
- Wallet onboarding step 2 now rotates those placeholder examples every three seconds through a Toronto-focused set of names, and the first name, last name, preferred name, and username placeholders all stay synchronised to the same active example.
