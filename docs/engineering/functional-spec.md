...
- **Treasury policy governance**: stewards can now vote on the overcollateralization target and on governance-triggered excess-capacity charity mints, making both treasury headroom policy and discretionary charity issuance part of the on-chain governance workflow even when the admin override is disabled.
