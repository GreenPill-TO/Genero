...
export const useSendMoney = ({
  ...
  const sendMoney = async (amount: string) => {
    ...
    try {
      ...
      // Set up ethers provider (assumes window.ethereum is available).
      ...
      const txResponse = await tokenContract.transfer(receiverWallet, parsedAmount);
